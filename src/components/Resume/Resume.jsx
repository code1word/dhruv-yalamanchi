...
export default function Resume(props) {
  ...
  */
  ...
  const skillCategories = {
    ...
    frameworks: [
      { skill: "Spring Boot", img: "springboot.svg", color: "#6DB33F" },
      { skill: "React", img: "react.svg", color: "#61DAFB" },
      { skill: "Node.js", img: "nodedotjs.svg", color: "#339933" },
      { skill: "PyTorch", img: "pytorch.svg", color: "#EE4C2C" },
      { skill: "Django", img: "django.svg", color: "#092E20", bg: "#ffffff" },
      { skill: "Flask", img: "flask.svg", color: "#ffffff" },
      { skill: "Express", img: "express.svg", color: "#ffffff" },
      { skill: "React Native", img: "react.svg", color: "#ffffff" },
      { skill: "Bootstrap", img: "bootstrap.svg", color: "#7952B3" },
      { skill: "Qiskit", img: "qiskit.svg", color: "#6929C4" },
    ],
    tools: [
      { skill: "AWS", img: "aws.svg", bg: "#ffffff" },
      { skill: "Git", img: "git.svg", color: "#F05032" },
      { skill: "GraphQL", img: "graphql.svg", color: "#E10098" },
      { skill: "MongoDB", img: "mongodb.svg" },
      { skill: "Datadog", img: "datadog.svg", color: "#632CA6", bg: "#ffffff" },
    ...
    libraries: [
      ...
      { skill: "Redux", img: "redux.svg", color: "#764ABC" },
      { skill: "spaCy", img: "spacy.svg", color: "#09A3D5" },
